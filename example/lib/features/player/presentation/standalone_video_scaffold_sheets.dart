part of 'standalone_video_scaffold.dart';
...
class PortraitMoreSheet {
  ...
  static Future<void> show({
    ...
    required StandaloneLoopMode loopMode,
    ...
    required ValueChanged<StandaloneLoopMode> onLoopModeChanged,
...
class _PortraitMoreSheetBodyState extends State<_PortraitMoreSheetBody> {
  ...
  late StandaloneLoopMode _loopMode = widget.loopMode;
  ...
  void _setLoopMode(StandaloneLoopMode mode) {
    setState(() {
      _loopMode = mode;
    });
      ...
      child: Row(
        children: [
          ...
          _LoopModeButton(
            ...
            selected: loopMode == StandaloneLoopMode.single,
            onPressed: () => onLoopModeChanged(StandaloneLoopMode.single),
            isDark: isDark,
          ),
          _LoopModeButton(
            label: strings.playlistLoopLabel,
            selected: loopMode == StandaloneLoopMode.playlist,
            onPressed: () => onLoopModeChanged(StandaloneLoopMode.playlist),
            isDark: isDark,
          ),
          _LoopModeButton(
            label: strings.noLoopLabel,
            selected: loopMode == StandaloneLoopMode.none,
            onPressed: () => onLoopModeChanged(StandaloneLoopMode.none),
            isDark: isDark,
          ),
        ],
      ),
